                        ...
                        <div className="col col-md-6 col-sm-8 col-xs-12 align-items-center">
                            <div className=" registration-main-box">
                                ...
                                <div className="text-input-container">
                                    <input id="username" className={"text-input " + (this.state.username.length === 0 && this.state.usernameUpdated ? 'empty' : 'filled')} onChange={this.usernameChanged} type="text" value={this.state.username} placeholder="Username" autoComplete="off"/>
                                    <label htmlFor="username"></label>
                                </div>
                                <div className="text-input-container">
                                    <input id="email" className={"text-input " + (this.state.email.length === 0 && this.state.emailUpdated ? 'empty' : 'filled')} onChange={this.emailChanged} type="email" value={this.state.email} placeholder="Email" autoComplete="off"/>
                                    <label htmlFor="email"></label>
                                </div>
                                <div className="text-input-container">
                                    <input id="password" className={"text-input " + (this.state.password.length === 0 && this.state.passwordUpdated ? 'empty' : 'filled')} onChange={this.passChanged} value={this.state.password} type="password" placeholder="Password" autoComplete="off"/>
